...
Only pathways in upper letter are enriched in `r params$prefix_name `.  


```{r DynamicPathways, echo=FALSE,warning=FALSE,message=FALSE, fig.show='asis'}
#data_nested_2=read.table( file=paste0( odir,HierarchieData,d,'_',t,"/",d,'_',t, "_table_REACTOME_Hierachie.txt"),na.strings="")
data_nested_2=read.table( file=paste0( odir,HierarchieData,params$prefix_name,"/",params$prefix_name, "_table_REACTOME_Hierachie.txt"))
...
Only pathways in upper bold letter are enriched in `r params$prefix_name `.  
