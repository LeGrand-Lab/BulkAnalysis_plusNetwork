  ...
  tabPanel( "L-R pairs" ,
     sidebarLayout(
        sidebarPanel( h4("Parameters"), width = 3,
                 ...
                 em("Size of node =  "),
                 em("ratio of the average expression level of the ligand/receptor"),
                 em("in the cluster to the sum of the average expression levels "),
                 em("of the ligand/receptor in every cluster"),
                 br(),
                 em("Size of edge = "),
                 em("the product of the ligand & receptor derived specificity of total expression values"),
                    ...
                    tabsetPanel(
                      ...
                      tabPanel("D0",
                               column(6,
                                  ...
                                  plotOutput("D0_MuSCs_UP")),
                               column(6,
                                      plotOutput("D0_ECs_DOWN"),
                                      plotOutput("D0_FAPs_DOWN"),
                                      plotOutput("D0_MuSCs_DOWN")),
                                     ),
                    tabPanel("D2",
                             column(6,
                                    plotOutput("D2_ECs_UP"),
                                    plotOutput("D2_FAPs_UP"),
                                    plotOutput("D2_Inflammatory-Mac_UP"),
                                    plotOutput("D2_Resolving-Mac_UP"),
                                    plotOutput("D2_Neutrophils_UP"),
                                    plotOutput("D2_MuSCs_UP")),
                             column(6,
                                    plotOutput("D2_ECs_DOWN"),
                                    plotOutput("D2_FAPs_DOWN"),
                                    plotOutput("D2_Inflammatory-Mac_DOWN"),
                                    plotOutput("D2_Resolving-Mac_DOWN"),
                                    plotOutput("D2_Neutrophils_DOWN"),
                                    plotOutput("D2_MuSCs_DOWN")),
                    ),
                    tabPanel("D4",
                             column(6,
                                    plotOutput("D4_ECs_UP"),
                                    plotOutput("D4_FAPs_UP"),
                                    plotOutput("D4_Inflammatory-Mac_UP"),
                                    plotOutput("D4_Resolving-Mac_UP"),
                                    plotOutput("D4_MuSCs_UP")),
                             column(6,
                                    plotOutput("D4_ECs_DOWN"),
                                    plotOutput("D4_FAPs_DOWN"),
                                    plotOutput(("D4_Inflammatory-Mac_DOWN")),
                                    plotOutput("D4_Resolving-Mac_DOWN"),
                                    plotOutput("D4_MuSCs_DOWN"))
                             ),
                    tabPanel("D7",
                             column(6,
                                    plotOutput("D7_ECs_UP"),
                                    plotOutput("D7_FAPs_UP"),
                                    plotOutput("D7_Resolving-Mac_UP"),
                                    plotOutput("D7_MuSCs_UP")),
                             column(6,
                                    plotOutput("D7_ECs_DOWN"),
                                    plotOutput("D7_FAPs_DOWN"),
                                    plotOutput("D7_Resolving-Mac_DOWN"),
                                    plotOutput("D7_MuSCs_DOWN"))
                             ) # "ECs"  "FAPs" "M2"   "sCs" 
                    ) # end tabsetPAnel
             ) #end column
           )
